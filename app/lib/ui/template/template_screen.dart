...
class TemplateScreren extends StatefulWidget {
  const TemplateScreren({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;

  @override
  _TemplateScrerenState createState() => _TemplateScrerenState();
}

class _TemplateScrerenState extends State<TemplateScreren>
